                ...
                <div className="slide-item">
                  <div className="case-study-card">
                    ...
                    <div className="case-study-content">
                      ...
                      <p>
                        Business consultants are typically hired by organizations of all sizes, from
                        small startups.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="case-study-content">
                      <div className="catgory-and-title">
                        ...
                        <h3>
                          <Link legacyBehavior href="/case-study-details">
                            <a>
                              Leading the Market: A Business Consulting Case Study with Healthcare
                            </a>
                          </Link>
                        </h3>
                      </div>
                  ...
                  <div className="case-study-card">
                    ...
                    <div className="case-study-content">
                      <div className="catgory-and-title">
                        ...
                        <h3>
                          <Link legacyBehavior href="/case-study-details">
                            <a>Sustainability in Business: Strategies for a Greener Future</a>
                          </Link>
                        </h3>
                      </div>
                      <p>
